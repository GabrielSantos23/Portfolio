    ...
    <HoverCard>
      ...
      <div>
        ...
        <div className="flex flex-col gap-4">
          ...
          >
            <span className="flex h-5 w-5 items-center justify-center rounded-full bg-green-500 bg-opacity-10">
